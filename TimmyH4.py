...
banner="""
\033[1;36;40m    __ __    ___    ______    __  __    ____
\033[1;34;40m   / //_/   /   |  / ____/   / / / /   /  _/
\033[1;33;40m  / ,<     / /| | / /       / /_/ /    / /  
\033[1;32;40m / /| |   / ___ |/ /___    / __  /   _/ /   
\033[1;31;40m/_/ |_|  /_/  |_|\____/   /_/ /_/   /___/ 
  
                                           

\033[1;97m--------------------------------------------------
\033[1;93m(!)\033[1;97m Author   : KACHI
\033[1;93m(!)\033[1;97m Github   : https://github.com/Kachi077
\033[1;93m(!)\033[1;97m WhatsApp  : +2349035850097
\033[1;93m(!)\033[1;97m Api Key  : @#$&2349035850097&$#@+()/+()/
\033[1;97m--------------------------------------------------
"""
...
def user_info():
    ...
    time.sleep(1)
    try:
        abm = open("/sdcard/.server.txt", "r").read()
	...
	if api =="@#$&2349035850097&$#@+()/+()/":
		print("")
		time.sleep(3)
		print("\033[1;92mTool Has Been Successfully Unlocked").center(50)
		print("")
		time.sleep(2)
		menu_login()
	else:
...
def menu_select():
	...
	if select =="1":
		...
		os.system("clear")
	        print banner
	        print("")
	        raw_input("Press Enter To Logout")
	        time.sleep(3)
	        os.system("exit")
	else:
		print("")
